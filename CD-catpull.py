...
parser = argparse.ArgumentParser(
	description ="Script to pull catalog metadata for cd-rom ISOs, Feb 2019")
parser.add_argument(
	'-l', '--lib', type=str,
...
with open(dir+'projectlog.csv','a+') as inlog:
...
#confirm = QtWidgets.QApplication(sys.argv)
#args = confirm.arguments()[1:]
#dialog = Dialog(diskpic)
#if dialog.exec_() == QtWidgets.QDialog.Accepted:
#	response=str(dialog.editor.text())
#else:
#	print('ERROR')
#	sys.exit(1)
